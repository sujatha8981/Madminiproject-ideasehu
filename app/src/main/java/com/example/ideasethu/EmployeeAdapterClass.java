...
public class EmployeeAdapterClass extends RecyclerView.Adapter<EmployeeAdapterClass.ViewHolder> {
    ...
    List<ModelClass> employee;
    Context context;
    DatabaseHelperClass databaseHelperClass;

    public EmployeeAdapterClass(List<ModelClass> employee, Context context) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        final ModelClass employeeModelClass = employee.get(position);
        ...
        holder.button_Edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseHelperClass.updateidea(new ModelClass(ModelClass.getId(), stringName, stringEmail));
        ...
        holder.button_delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                databaseHelperClass.deleteidea(ModelClass.getId());
